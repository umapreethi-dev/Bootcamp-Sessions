...
// Use (dbName) // will switch to the db and create the db
// db // will show current db(d is small)
...
//For inclusion use number 1
// filtering only names
db.movies.find({}, {name: 1})


// filtering only names and rating
db.movies.find({}, {name: 1, rating: 1})

// For exclusion use number 0
// excluding trailer nad summary
